...
from general_navigation.diffusion_policy.common.checkpoint_util import (
    TopKCheckpointManager,
)
from general_navigation.diffusion_policy.common.json_logger import JsonLogger
from general_navigation.diffusion_policy.common.pytorch_util import (
    dict_apply,
    optimizer_to,
)
from general_navigation.diffusion_policy.dataset.base_dataset import (
    BaseLowdimDataset,
)
from general_navigation.diffusion_policy.env_runner.base_lowdim_runner import (
    BaseLowdimRunner,
)
from general_navigation.diffusion_policy.model.common.normalizer import (
    LinearNormalizer,
    SingleFieldLinearNormalizer,
)
from general_navigation.diffusion_policy.policy.bet_lowdim_policy import (
    BETLowdimPolicy,
)
from general_navigation.diffusion_policy.workspace.base_workspace import (
    BaseWorkspace,
)
                ...
                with tqdm.tqdm(
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        step_log = {
                            ...
                            "epoch": self.epoch,
                            "train_loss_offset": loss_components[
                                "offset"
                            ].item(),
                            "train_loss_class": loss_components[
                                "class"
                            ].item(),
                        }
                    ...
                    with torch.no_grad():
                        ...
                        with tqdm.tqdm(
                            ...
                            for batch_idx, batch in enumerate(tepoch):
                                ...
                                raw_loss, loss_components = (
                                    self.policy.compute_loss(batch)
                                )
